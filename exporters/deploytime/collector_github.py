...
from pelorus.config.converters import comma_or_whitespace_separated, url
from pelorus.utils import CachedData, TokenAuth, join_url_path_components
...
class GitHubReleaseCollector(AbstractPelorusExporter):
    ...
    host: Url = field(
        default="api.github.com", converter=url, metadata=env_vars("GIT_API")
    )
    ...
    def __attrs_post_init__(self):
        ...
        self._client = RateLimitingClient(session)
